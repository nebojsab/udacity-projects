...
var HTMLmobile = '<li class="flex-item"><span class="orange-text"><i class="fa fa-mobile"></i></span><span class="text-color">%data%</span></li>';
var HTMLemail = '<li class="flex-item"><span class="orange-text"><i class="fa fa-envelope-o"></i></span><span class="text-color">%data%</span></li>';
var HTMLtwitter = '<li class="flex-item"><span class="orange-text"><i class="fa fa-twitter"></i></span><span class="text-color">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><span class="orange-text"><i class="fa fa-github"></i></span><span class="text-color">%data%</span></li>';
var HTMLblog = '<li class="flex-item"><span class="orange-text"><i class="fa fa-pencil"></i></span><span class="text-color">%data%</span></li>';
var HTMLlocation = '<li class="flex-item"><span class="orange-text"><i class="fa fa-map-marker"></i></span><span class="text-color">%data%</span></li>';

var HTMLbioPic = '<img src="%data%" width="200" height="200" alt="Nebojsa Brnjasevic" class="biopic">';
...
var HTMLprojectImage = '<div>%data%</div>';
